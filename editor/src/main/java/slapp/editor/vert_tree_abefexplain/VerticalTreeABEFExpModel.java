...
public class VerticalTreeABEFExpModel implements ExerciseModel<Document>, Serializable {
    ...
    void setABChoiceLead(String abChoiceLead) {
    ...
    void setaSelected(boolean aSelected) {   this.aSelected = aSelected;  }
    ...
    void setEFChoiceLead(String efChoiceLead) {
        this.efChoiceLead = efChoiceLead;
    }

    void setePrompt(String ePrompt) {
        this.ePrompt = ePrompt;
    }

    void seteSelected(boolean eSelected) {
        this.eSelected = eSelected;
    }

    void setfPrompt(String fPrompt) {
        this.fPrompt = fPrompt;
    }

    void setfSelected(boolean fSelected) {
    ...
    String getABChoiceLead() {return abChoiceLead; }
    ...
    String getEFChoiceLead() {return efChoiceLead; }
    String getePrompt() { return ePrompt; }
    boolean iseSelected() { return eSelected; }
    String getfPrompt() { return fPrompt; }
    boolean isfSelected() { return fSelected; }
