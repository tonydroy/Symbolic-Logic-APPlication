...
public class VerticalTreeABEFExpView implements ExerciseView<DecoratedRTA> {
    ...
    VerticalTreeABEFExpView(MainWindowView mainView, VerticalTreeABEFExpExercise vtABEFExpExercise) {
...
//        checksBox.setMargin(checkProgButton, new Insets(0,0,10, 0));
    ...
    public VerticalTreeABEFExpExercise getVtABEFExpExercise() {
        return vtABEFExpExercise;
    }
}
