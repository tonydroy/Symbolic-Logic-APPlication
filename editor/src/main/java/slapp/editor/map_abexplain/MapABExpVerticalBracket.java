...
public class MapABExpVerticalBracket extends AnchorPane {
    ...
    private final MapABExpVerticalBracket self;

    private VBox mainPane;



    public MapABExpVerticalBracket(MapABExpView mapView) {
        self = this;
...
//        brackPane.setMinHeight(24); brackPane.setMaxHeight(24);
        ...
        slapp.editor.map_abexplain.MapABExpBottomDragResizer resizer = new MapABExpBottomDragResizer(mapView);
