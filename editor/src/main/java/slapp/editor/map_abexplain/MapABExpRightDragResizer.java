...
/**
 * {@link MapABExpRightDragResizer} can be used to add mouse listeners to a {@link Region}
 ...
 *
 */
public class MapABExpRightDragResizer {
    ...
    public MapABExpRightDragResizer(MapABExpView mapView) {
        this.verticalTreeView = mapView;
    }
