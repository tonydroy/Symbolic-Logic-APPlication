...
public class MapABExpDashedLine extends AnchorPane {
    ...
    private final MapABExpDashedLine self;

    private AnchorPane mainPane;



    public MapABExpDashedLine(MapABExpView mapView) {
        self = this;
...
//            leftDragLabel.setCursor(Cursor.MOVE);
        ...
        MapABExpRightDragResizer resizer = new MapABExpRightDragResizer(mapView);
