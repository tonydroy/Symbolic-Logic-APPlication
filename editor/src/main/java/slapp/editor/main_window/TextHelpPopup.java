...
static {
    ...
    commonElements = "<body style=\"margin-left:10; margin-right: 20\">" +
            ...
            "The bottom of the keyboard diagram lists keyboard shortcuts. There is also a list of shortcuts from the Help dropdown.   Note that there is no 'right-click' context menu so that these commands come only by edit controls at the top and by the keyboard shortcuts. <br><br>" +
            ...
            "<li>In its current version, the RTA may crash in case you attempt to copy and paste an <i>indented</i> line or paragraph.  In this case, you should see a popup warning: save your work, then close and restart SLAPP.  You should not have lost any of your work.<br><br></li>" +
            "<li>Some of the RTA insert options (lists, pictures, and such) are fairly primitive.  In particular, an inserted table gives strange behavior unless immediately against a margin.    </li></ul>" +
            "</ol>"
            ;
