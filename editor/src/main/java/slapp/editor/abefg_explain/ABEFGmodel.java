...
/**
 * The model for AB/EFG page edit exercise
 */
public class ABEFGmodel implements ExerciseModel<Document>, Serializable {
     ...
     */
    List<PageContent> getPageContents() { return pageContents;  }
     ...
     * @return the ABEFGmodelExtra object
     */
     ...
     * @return the ABEFG_EXPLAIN exercise type
     */
    @Override
